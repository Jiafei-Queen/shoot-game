 ...
 * {@link EnemyAI#bulletTimeToEnemy} (time until a bullet enters the hitbox)
 * and {@link EnemyAI#dodgeAimAngle} (aim so the recoil dodges an incoming
...
class EnemyAIMathTest {
    ...
    void bulletAimedAtBodyHits() {
        ...
        float t = EnemyAI.bulletTimeToEnemy(-300f, 0f, BULLET_SPEED, 0f, e, HIT_RADIUS);
    ...
    void bulletMovingAwayNeverHits() {
        Shooter e = enemyAt(0f, 0f, 0f);
        assertEquals(-1f, EnemyAI.bulletTimeToEnemy(-300f, 0f, -BULLET_SPEED, 0f, e, HIT_RADIUS), EPS);
    }

    @Test
    void bulletAboveGunNeverHits() {
        Shooter e = enemyAt(0f, 0f, 0f);
        assertEquals(-1f, EnemyAI.bulletTimeToEnemy(-300f, 100f, BULLET_SPEED, 0f, e, HIT_RADIUS), EPS);
    }
    ...
    void rotationIsAccountedFor() {
        ...
        float t = EnemyAI.bulletTimeToEnemy(0f, -300f, 0f, BULLET_SPEED, e, HIT_RADIUS);
        assertEquals(290f / BULLET_SPEED, t, EPS);
    }
    ...
    void bulletAlreadyInsideHitsImmediately() {
        Shooter e = enemyAt(0f, 0f, 0f);
        assertEquals(0f, EnemyAI.bulletTimeToEnemy(10f, 0f, BULLET_SPEED, 0f, e, HIT_RADIUS), EPS);
    }
    ...
    void enemyAbovePathFiresDown() {
        ...
        float aim = EnemyAI.dodgeAimAngle(0f, 100f, 0f, 0f, BULLET_SPEED, 0f);
    ...
    void enemyRightOfVerticalBulletFiresLeft() {
        ...
        float aim = EnemyAI.dodgeAimAngle(100f, 0f, 0f, 0f, 0f, BULLET_SPEED);
        assertEquals(MathUtils.PI, aim, EPS);
    }

    @Test
    void degenerateBulletVelocityFiresForward() {
        assertEquals(0f, EnemyAI.dodgeAimAngle(0f, 100f, 0f, 0f, 0f, 0f), EPS);
    }
}
